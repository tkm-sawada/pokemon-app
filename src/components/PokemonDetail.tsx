        ...
        {isLoading ? (
          ...
          <div className="relative md:w-5/6 w-full mx-auto">
            ...
            <table className="w-full my-6 shadow overflow-hidden rounded border-gray-200">
              <tbody>
                <tr>
                  <th className="md:w-1/3 w-1/4 text-center py-2 bg-gray-200">タイプ</th>
                  <td className="flex text-left py-2 pl-8">
                    {pokemonDetails[variety].types.map((type: Type, i: number) => {
                      return <div className="flex items-center mr-2 text-white" key={i}>
                                <div className={"md:px-3 px-1 py-1 rounded-l " +  type.color}><FontAwesomeIcon icon={type.icon} /></div>
                                <div className="md:px-3 px-1 py-1 rounded-r bg-gray-600">{type.typeName}</div>
                              </div>;
                    })}
                  </td>
                </tr>
                <tr>
                  <th className="md:w-1/3 w-1/4 text-center py-2 bg-gray-200">高さ</th>
                  <td className="md:w-2/3 w-3/4 text-left py-2 pl-8">{pokemonDetails[variety].height}m</td>
                </tr>
                <tr>
                  <th className="md:w-1/3 w-1/4 text-center py-2 bg-gray-200">重さ</th>
                  <td className="md:w-2/3 w-3/4 text-left py-2 pl-8">{pokemonDetails[variety].weight}kg</td>
                </tr>
                <tr>
                  <th className="md:w-1/3 w-1/4 text-center py-2 bg-gray-200">特性</th>
